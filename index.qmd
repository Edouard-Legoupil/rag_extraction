...
Artificial Inteligence (AI) is presented as the potential source for the next, actually the [fifth waves](https://www.nature.com/articles/s41599-019-0253-6) of the **evidence revolution**. This actually reflects a situation where after years of evaluation studies and [thousands of published evaluation reports](https://www.uneval.org/evaluation/reports), the new frontier is about **information retrieval and evidence generalization** : How to extract the most relevant findings and recommendations from a context and reuse them in a different but appropriate context?

![From Nature: The twenty-first century experimenting society: the four waves of the evidence revolution, https://www.nature.com/articles/s41599-019-0253-6](GIZQ0_MWYAAZiUJ.png){fig-align="center"}
...
-   First, we explain how to create a two-pager evaluation brief using an orchestration of models and functions. Rather than relying on ad-hoc user interactions through a black box chat interface, it is possible to set up a documented and reproducible summarization scripts that can directly output a word document. The same approach could be applied to other textual analysis, for instance: extract causal theory of change from transcriptions of Focus Group Discussions Transcriptions, or review the usage of Evidence within Country Strategic Plan...

-   Second, we review the techniques that can be used to optimize summarisation scripts by exploring different metrics to evaluate information retrieval process.

-   Last we discuss how such approach can actually inform decisions and strategies on future AI Deployment approaches.
:::
...
We use the the 2019 [Evaluation of UNHCR’s data use and information management approaches](https://www.unhcr.org/sites/default/files/legacy-pdf/5dd4f7d24.pdf) to illutrate the process.
...
## Stage 0: Python Environment and libraries
...
There are multiple options to do that - but an easy one is to install [OLLAMA](https://ollama.com/). Langchain as dedicated [module to work with ollama](https://python.langchain.com/docs/integrations/chat/ollama). We are using here [Mixtral Sparse Mixture-of-Expert](https://mistral.ai/news/mixtral-of-experts/), and specifically the quantized version: [8x7b-instruct-v0.1-q4_K_M](https://huggingface.co/TheBloke/Mixtral-8x7B-Instruct-v0.1-GGUF#explanation-of-quantisation-methods), an open-weight model designed to optimize performance-to-cost ratio, aka small in size to run on a strong laptop but good in performance. This download a file with the model which suze around 26Gb.
