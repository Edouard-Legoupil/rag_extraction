...
Blind trust in AI definitely comes with serious risks that have been extensively discussed (Bias and Discrimination, Lack of Transparency and Explainability, etc.). Trust building will therefore require organisational investment to continuously assess the results both from an information retrieval side and from a faithfulness side.  
